...
(define (mover e k)
(cond
[(key=? k "up") (if (<= (- (list-ref e 0) VELOCIDAD) 75)
e
(make-package (list (- (list-ref e 0) VELOCIDAD) (list-ref e 1) (list-ref e 2) (list-ref e 3))
(list (- (list-ref e 0) VELOCIDAD) (list-ref e 1) (list-ref e 2) (list-ref e 3))
)
)
]
[(key=? k "down") (if (>= (+ (list-ref e 0) VELOCIDAD) 625)
e
(make-package (list (+ (list-ref e 0) VELOCIDAD) (list-ref e 1) (list-ref e 2) (list-ref e 3))
(list (+ (list-ref e 0) VELOCIDAD) (list-ref e 1) (list-ref e 2) (list-ref e 3))
)
